...
namespace GameBase.Controllers
{
    public class LanguagesController : Controller
    {
        ...
        public LanguagesController(IDbContext db)
        {
            _db = db;
        }
        ...
        {
            return View(_db.Set<Language>().ToList());
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            Language language = _db.Set<Language>().Find(id);
            if (language == null)
            {
                return HttpNotFound();
            }
        ...
        {
            Language language = _db.Set<Language>().Find(id);
            _db.Set<Language>().Remove(language);
            _db.SaveChanges();
            return RedirectToAction("Index");
        }
